...
// same password as another account
public class TC6_TestSignupPage_Invalid
{
    public static void main(String[] args)
    {
        ...
        driver.findElement(By.name("username")).sendKeys("a.samy");
        ...
        driver.findElement(By.name("contact")).sendKeys("0124455869");
