...
public class TC1_SearchInBorrowedBooks
{
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//a[@href='view_borrow.php']")).click();
        driver.findElement(By.xpath("//div[@id='example_filter']//label//input[@type='text']")).sendKeys("Assemble Language Programming");
